...
public class EDIT_CARD_ACTIVITY extends AppCompatActivity {
    ...
    private void inflateAd(NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(EDIT_CARD_ACTIVITY.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(EDIT_CARD_ACTIVITY.this, nativeAd, nativeAdLayout);
    ...
    public void banner_add() {
        banner_adView = new AdView(this, getResources().getString(R.string.edit_card_banner), AdSize.BANNER_HEIGHT_50);

        // Find the Ad Container
        LinearLayout adContainer = findViewById(R.id.edit_banner_container);
